...
export const metadata: Metadata = {
  title: 'Help Center - MyStockPortfolio',
...
export default function HelpPage() {
  const faqs = [
    {
      question: "Is MyStockPortfolio really free forever?",
    ...
    {
      question: "Can I contribute to MyStockPortfolio?",
      answer: "We'd love that! MyStockPortfolio is open source and community-driven. Check our GitHub for issues marked 'good first issue' or 'help wanted'. Every contribution, no matter how small, makes a difference."
    },
    {
