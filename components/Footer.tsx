                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-10 max-w-md">
                            MyStockPortfolio is an open-source alternative to expensive market platforms. Track real-time prices, set personalized alerts, and explore detailed company insights — built openly, for everyone, forever free.
                        </p>
                        <div className="flex space-x-6">
                            <Link
                                href="https://github.com/Jineshkumar1"
                                target="_blank"
                            ...
                            <Link
                                href="https://www.linkedin.com/in/jineshkumarpatel/"
                                target="_blank"
                                rel="noopener noreferrer"
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="text-gray-400 text-sm mb-4 md:mb-0">
                            © {new Date().getFullYear()} MyStockPortfolio. All rights reserved.
                        </div>
                    </div>
                </div>
            </div>
